// Q U A N T U M S O U N D
import java.util.Map;
// Clock segments, coordinates for segments: top 012, middle 345, bottom 678
int[][] _q = {{0, 2}, {0, 6}, {6, 8}, {2, 8}, {4, 8}};
int[][] _u = {{0, 6}, {2, 8}, {6, 8}};
int[][] _a = {{0, 2}, {0, 6}, {2, 8}, {3, 5}}; // For a more pointy A {{0, 1}, {1, 8}, {3, 5}};
int[][] _n = {{0, 6}, {0, 8}, {2, 8}};
int[][] _t = {{0, 2}, {1, 7}};
int[][] _m = {{0, 6}, {0, 2}, {1, 7}, {2, 8}};
int[][] _s = {{0, 2}, {0, 3}, {3, 5}, {5, 8}, {8, 6}};
int[][] _o = {{0, 6}, {2, 8}, {6, 8}, {0, 2}};
int[][] _d = {{0, 6}, {0, 1}, {6, 7}, {1, 5},{5, 7}};
int[][] _h = {{0, 6}, {2, 8}, {3, 5}};
int[][] _k = {{0, 6}, {3, 2}, {3, 8}};
int[][] _p = {{0, 6}, {0, 2}, {2, 5}, {5, 3}};
int[][] _f = {{0, 6}, {0, 2}, {5, 3}};
int[][] _r = {{0, 6}, {0, 2}, {2, 5}, {5, 3}, {4, 8}};
int[][] _e = {{0, 6}, {0, 2}, {6, 8}, {3, 4}};
int[][] _l = {{0, 6}, {6, 8}};
int[][] _i = {{1, 7}};
int[][] _c = {{0, 6}, {0, 2}, {6, 8}};
int[][] _y = {{7, 4}, {4, 0}, {4, 2}};
int[][] _b = {{0, 6}, {0, 2}, {6, 8}, {2, 4}, {4,8}, {3, 4}};
int[][] _ = {};
float temp;
class Letter {
  int[][] segments;
